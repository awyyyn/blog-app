...
export type Query = {
  ...
  getMostTalkedPosts?: Maybe<Array<Maybe<PostResult>>>;
...
export type GetMostTalkedPostsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMostTalkedPostsQuery = { __typename?: 'Query', getMostTalkedPosts?: Array<{ __typename?: 'PostResult', id: string, title: string, createdAt: string, description?: string | null, author?: { __typename?: 'User', firstname: string, lastname: string } | null } | null> | null };
...
export const GetMostTalkedPostsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMostTalkedPosts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getMostTalkedPosts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"author"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstname"}},{"kind":"Field","name":{"kind":"Name","value":"lastname"}}]}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<GetMostTalkedPostsQuery, GetMostTalkedPostsQueryVariables>;
